--// Configuration \\--
local debugprints = true -- Set to false if you don't want it to print things in your console.
--// End \\--
CreateGui = function()
...
D_E_X.Parent = game.Players.LocalPlayer.CoreGui
if debugprints == true then printconsole("Dex GUI created") end
spawn(function()
	local Gui = D_E_X
